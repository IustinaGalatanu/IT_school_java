...
public class PizzaOrderSistem {
    public static void main(String[] args) {
        ...
        long numOfOrders=orders.stream()
                .filter(o->o.getToppings().contains("carne"))
                .count();

        System.out.println(numOfOrders);

        boolean hasVeganPizza=orders.stream()
                .anyMatch(o->!o.getToppings().contains("carne"));
